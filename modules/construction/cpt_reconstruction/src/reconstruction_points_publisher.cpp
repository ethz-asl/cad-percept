...
namespace cpt_reconstruction{	
	...
	ReconstructionPointsPublisher::ReconstructionPointsPublisher(ros::NodeHandle nodeHandle, std::string filename,
																 int batch_size) {
	...
	void ReconstructionPointsPublisher::publishPoints() {
		...
		ros::Publisher chatter_publisher = nodeHandle_.advertise<::cpt_reconstruction::coordinates>("point", 1000);
