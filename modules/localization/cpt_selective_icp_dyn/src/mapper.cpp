...
bool Mapper::setReferenceFacets(cpt_selective_icp_dyn::References::Request &req,
                                cpt_selective_icp_dyn::References::Response &res) {
  if (reference_mesh_ == nullptr) {
    std::cerr << "[cpt_selective_icp_dyn] Tried to set references before mesh-model was loaded."
              << std::endl;
    return false;
  }
...
bool Mapper::setReferenceTask(cpt_selective_icp_dyn::BuildingTask::Request &req,
