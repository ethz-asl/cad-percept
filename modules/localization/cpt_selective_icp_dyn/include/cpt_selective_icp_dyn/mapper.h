#ifndef SELECTIVE_ICP_DYN_MAPPER_H_
#define SELECTIVE_ICP_DYN_MAPPER_H_
...
class Mapper {
 ...
 protected:
   ...
   */
  bool setReferenceFacets(cpt_selective_icp_dyn::References::Request &req,
                          cpt_selective_icp_dyn::References::Response &res);
  bool setReferenceTask(cpt_selective_icp_dyn::BuildingTask::Request &req,
                        cpt_selective_icp_dyn::BuildingTask::Response &res);
...
#endif  // SELECTIVE_ICP_DYN_MAPPER_H_
